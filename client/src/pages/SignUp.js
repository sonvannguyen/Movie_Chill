    ...
    <div className="h-screen relative">
      ...
      <div className="absolute top-1/2 left-1/2 translate-x-[-50%] translate-y-[-50%] w-[400px] bg-[#000000bc] p-10">
        ...
        <div className="flex flex-col mt-8">
          ...
          <input type="text" id="username" placeholder="example123" className="py-3 px-5 mt-1 bg-zinc-700 outline-none rounded-lg" />
        </div>
        ...
        <button className="w-full bg-red-600 py-3 rounded-lg mt-6 font-bold hover:bg-red-500">Create new account</button>
        <h4 className="mt-8 mb-2 text-center">Do you already have an account ?</h4>
        <button className="tag-primary block my-0 mx-auto font-bold">Login here</button>
      </div>
    </div>
  );
};
