      ...
      <div className="bg-white w-[420px] rounded-lg px-8 pt-8 pb-6 overflow-hidden shadow-xl transform transition-all">
        ...
        <div className="flex gap-7 mt-5 sm:mt-6">
            ...
            <button
              ...
              type="button"
              className="inline-flex justify-center w-full rounded-md border border-transparent px-4 py-2 bg-indigo-600 text-base leading-6 font-medium text-white hover:bg-indigo-500 focus:outline-none focus:border-indigo-700 focus:shadow-outline-indigo transition ease-in-out duration-150 sm:text-sm sm:leading-5"
            >
              Xác nhận
            </button>
        </div>
