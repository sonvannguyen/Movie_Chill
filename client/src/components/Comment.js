    ...
    return (
        <div>
            <div className="bg-[#3f3f46ad] inline-block rounded-xl mt-4 relative">
                <div className="flex md:pl-6 md:pr-12 px-1 py-2 gap-2 md:gap-6 md:max-w-[570px] overflow-hidden">
                    <img  
                    ...
                    <div>
                        ...
                        <p className="text-sm md:text-base text-[#ffffffa1]">{commentData?.commentContent}</p>

                        <div className='border-t border-[rgba(255,255,255,0.27)] mt-[6px] text-[12px] text-slate-300 italic flex items-center justify-between'>
