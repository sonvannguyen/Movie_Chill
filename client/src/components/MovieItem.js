            ...
            <div className="relative group" >
                <div className="overflow-hidden group rounded-md">
                    <img 
                        ...
                        className='min-h-[260px] max-h-[260px] object-cover rounded-md cursor-pointer group-hover:opacity-70 group-hover:scale-105 transition duration-300 ease-in-out'
                        alt="thumb img" 
                    />
                </div>
